...
class PHP_CodeCoverage_Report_HTML
{
    ...
    private function copyFiles($target)
    {
        ...
        $dir = $this->getDirectory($target . 'font');
        copy($this->templatePath . 'font/glyphicons-halflings-regular.eot', $dir . 'glyphicons-halflings-regular.eot');
        copy($this->templatePath . 'font/glyphicons-halflings-regular.svg', $dir . 'glyphicons-halflings-regular.svg');
        copy($this->templatePath . 'font/glyphicons-halflings-regular.ttf', $dir . 'glyphicons-halflings-regular.ttf');
        copy($this->templatePath . 'font/glyphicons-halflings-regular.woff', $dir . 'glyphicons-halflings-regular.woff');
        copy($this->templatePath . 'font/glyphicons-halflings-regular.woff2', $dir . 'glyphicons-halflings-regular.woff2');
